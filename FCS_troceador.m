...
for k=1:intervalos
    ...
    %fnamegraba=[fname(1:end-4), '_', num2str(k), '.fcs'];
    %ISSwrite(FCS_intervalo(:,1), FCS_intervalo(:,2), sampfreq, intclock, bitprecision, fnamegraba);
    %ISSwrite(FCS_intervalo(:,1), FCS_intervalo(:,2), sampfreq, intclock, 16, fnamegraba);
end